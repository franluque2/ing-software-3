...
#### 4- Creando el primer Pipeline Job
  ...
  - Analizar la salida del mismo
   ...
   Hello world se crea correctamente.
...
#### 5- Creando un Pipeline Job con Git y Maven
  ...
  Simple maven copia codigo de un repo, corre tests de maven, y despues los guarda.
  
  
  
  No pude realizar el punto 6 o 7 por problemas de git y un disco duro :(
